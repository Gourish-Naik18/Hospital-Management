...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="p-8">
        ...
        <p class="text-gray-500 mb-8">
            Book appointment with experienced specialists.
        </p>

        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <%DoctorDAO ddao = new DoctorDAOImpl();%>
          <%List<Doctor> ld = ddao.get_AllDoctor();%>
          <%List<Doctor> availableDoctors =  ld.stream().filter((ddd)->ddd.getAvailable().equalsIgnoreCase("yes")).toList();%>
          <%for(Doctor d : availableDoctors){%>
            ...
            <div class="bg-white rounded-2xl shadow p-6 hover:shadow-xl transition">
                ...
                <a href="book_appointment.jsp?doctorId=<%=d.getDoctor_id()%>"
